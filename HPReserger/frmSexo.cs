...
{
    public partial class frmSexo : FormGradient
    {
        public frmSexo()
        {
            InitializeComponent();
        ...
        private void btnaceptar_Click(object sender, EventArgs e)
        {
            if (estado == 1)
            {
                ...
                foreach (DataGridViewRow valor in dtgconten.Rows)
                {
                    ...
                    {
                        msg("El Sexo ya Existe");
                        txtgerencia.Focus();
                        return;
                    }
                }
                //Insertando;
                CCargos.InsertarActualizarSexo(0, 1, txtgerencia.Text, frmLogin.CodigoUsuario);
            ...
            if (estado == 2)
            {
                ...
                //modificando
                CCargos.InsertarActualizarSexo(int.Parse(txtcodigo.Text), 2, txtgerencia.Text, frmLogin.CodigoUsuario);
