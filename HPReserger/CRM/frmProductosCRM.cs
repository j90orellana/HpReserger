...
{
    public partial class frmProductosCRM : XtraForm
    {
        public frmProductosCRM()
        {
            InitializeComponent();
        }
        ...
        public void ExportarGridControlAExcel(GridControl gridControl)
        {
            ...
            saveFileDialog.FileName = "Reporte Productos.xlsx";
        ...
        private void frmProductosCRM_Load(object sender, EventArgs e)
        {
        ...
        private void CargarDatos()
        {
            ...
            HpResergerNube.CRM_ProductoRepository objClase = new HpResergerNube.CRM_ProductoRepository();
            gridControl2.DataSource = objClase.GetAllProductos();// (((DateTime)dtpFechade.EditValue).Date, ((DateTime)dtpFechaa.EditValue).Date);
        }
        ...
        private void gridView2_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                object cellValue = view.GetRowCellValue(view.FocusedRowHandle, xID_Producto.FieldName);
                frmAddProducto xVentanaHijo = new frmAddProducto();
                xVentanaHijo._idProducto = cellValue.ToString();
                xVentanaHijo.Show();
            }
        }
    }
