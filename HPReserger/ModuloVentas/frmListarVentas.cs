...
{
    public partial class frmListarVentas : XtraForm
    {
        ...
        private void ExportarGridAExcel()
        {
            try
            {
                ...
                string nombreArchivo = $"Listado de Comprobantes de Venta - {fecha}.xlsx";
        ...
        private void FiltrarFacturasDeVentas()
        {
            ...
            DataTable tdata = CFactura.BuscarFiltradoVentas(fechaDesde, fechaHasta, empresa, proveedor, glosa, OcultarPP, nrocomprobante);
        ...
        private void frmListarVentas_Load(object sender, EventArgs e)
        {
            ...
            xRazonSocial.FieldName = "Nombre_Completo";
            xRazonSocial.Caption = "Nombre Cliente";
            ...
            if (cboPresupuestos.EditValue != null)
            {
                ...
                for (int i = 0; i < view.RowCount; i++)
                {
                    ...
                    if (Convert.ToInt32(valorIdPP) == 0 || SaltarLlenos)
                    {
                        ...
                        Cclase.InsertarUpdateBuscarVentas(idFactura, ValorTipoFactura, idSeleccionado);
