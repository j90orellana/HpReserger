namespace SISGEM.ModuloFinanzas
{
    partial class frmListadoMutuos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.xnumeroDni = new DevExpress.XtraGrid.Columns.GridColumn();
            this.xnombreEmpleado = new DevExpress.XtraGrid.Columns.GridColumn();
            this.xcorrelativo = new DevExpress.XtraGrid.Columns.GridColumn();
            ...
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Sum, "total", this.xTotal, "{0:n2}", new decimal(new int[] {
                            ...
                            0,
                            0})),
            new DevExpress.XtraGrid.GridGroupSummaryItem(DevExpress.Data.SummaryItemType.Count, "Proveedor", this.xnumeroDni, "R. {0}", new decimal(new int[] {
                            0,
                            0,
                            0,
                            0}))});
            ...
            this.xnumeroDni.OptionsColumn.ReadOnly = true;
            this.xnumeroDni.Summary.AddRange(new DevExpress.XtraGrid.GridSummaryItem[] {
            new DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "Numero", "{0}")});
            this.xnumeroDni.Visible = true;
            this.xnumeroDni.VisibleIndex = 1;
            this.xnumeroDni.Width = 100;
            // 
            // xnombreEmpleado
            // 
            ...
            this.xnombreEmpleado.Width = 200;
            // 
            // xcorrelativo
            // 
        ...
        private DevExpress.XtraGrid.Columns.GridColumn xnumeroDni;
        private DevExpress.XtraGrid.Columns.GridColumn xnombreEmpleado;
        private DevExpress.XtraGrid.Columns.GridColumn xcorrelativo;
