...
{
    public partial class frmGradoInstitucional : FormGradient
    {
        public frmGradoInstitucional()
        {
            InitializeComponent();
        }
        ...
        {
            dtgconten.DataSource = CCargos.getCargoTipoContratacion("Id_GrdInstruccion", "GradoInstruccion", "TBL_GradoInstruccion");
            dtgconten.Focus();
        }
        private void frmGradoInstitucional_Load(object sender, EventArgs e)
        {
            CargarDatos();
        ...
        private void btnnuevo_Click(object sender, EventArgs e)
        {
            ...
            iniciar(true);
            txtgerencia.Text = "";
            DataRow codigo = CCargos.VerUltimoIdentificador("TBL_GradoInstruccion", "Id_GrdInstruccion");
        ...
        private void btnaceptar_Click(object sender, EventArgs e)
        {
            if (estado == 1)
            {
                ...
                {
                    Msg("Ingresé Nombre del Grado Institucional");
                    txtgerencia.Focus();
                    return;
                }
                foreach (DataGridViewRow valor in dtgconten.Rows)
                {
                    ...
                    {
                        Msg("El Grado Institucional ya Existe");
                        txtgerencia.Focus();
                        return;
                    }
                }
                //Insertando;
                CCargos.InsertarActualizarGradoInstruccion(0, 1, txtgerencia.Text, frmLogin.CodigoUsuario);
            ...
            if (estado == 2)
            {
                ...
                //modificando
                CCargos.InsertarActualizarGradoInstruccion(int.Parse(txtcodigo.Text), 2, txtgerencia.Text, frmLogin.CodigoUsuario);
