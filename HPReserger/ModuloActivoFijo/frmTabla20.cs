...
{
    public partial class frmTabla20 : XtraForm
    {
        public frmTabla20()
        {
            InitializeComponent();
        ...
        {
            HPResergerCapaLogica.oMetodoDepreciacion oclase = new HPResergerCapaLogica.oMetodoDepreciacion
            {
                Pkid = 0,
                Nombre = "Nuevo",
                IdS = 0,
            ...
            HPResergerCapaLogica.T20MetodoDepreciacion crud = new HPResergerCapaLogica.T20MetodoDepreciacion();
        ...
        {
            HPResergerCapaLogica.T20MetodoDepreciacion oclasebaja = new HPResergerCapaLogica.T20MetodoDepreciacion();
