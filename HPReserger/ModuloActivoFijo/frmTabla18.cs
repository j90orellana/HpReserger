...
{
    public partial class frmTabla18 : XtraForm
    {
        public frmTabla18()
        {
            InitializeComponent();
        ...
        {
            HPResergerCapaLogica.T18TipoActivoFijo.oTipoActivoFijo oclase = new HPResergerCapaLogica.T18TipoActivoFijo.oTipoActivoFijo
            {
                Pkid = 0,
                Nombre = "Nuevo",
                IdS = 0,
            ...
            HPResergerCapaLogica.T18TipoActivoFijo crud = new HPResergerCapaLogica.T18TipoActivoFijo();
        ...
        {
            HPResergerCapaLogica.T18TipoActivoFijo oclasebaja = new HPResergerCapaLogica.T18TipoActivoFijo();
